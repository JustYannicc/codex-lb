...
- **WHEN** the purge invalidation bump is processed
- **THEN** the idle floor (the HTTP-bridge request budget, which bounds the whole bridge request) keeps the session registered and open
