...
- **WHEN** the purge invalidation bump is processed
- **THEN** the idle floor (the request budget, which bounds the whole request) keeps the session registered and open
