...
- [x] 1.1 Prove missing PR area labels through the pinned action's emitted requests, then extend mappings.
- [x] 1.2 Prove new issue label requests for API/form titles, then add the metadata-only issue workflow.
