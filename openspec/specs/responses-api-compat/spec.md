...
more than one item, or a one-item JSON array whose compact JSON serialization
(`ensure_ascii=true` and no separator whitespace) is at least 4096 characters. A
