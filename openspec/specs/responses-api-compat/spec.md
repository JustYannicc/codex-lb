...
more than one item, or a one-item JSON array whose compact serialization of the
...
other input shape MUST be classified as delta-only. Exactly 4096 characters is
