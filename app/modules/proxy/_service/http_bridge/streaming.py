        ...
        *,
        ...
        try:
                ...
                *,
                ...
                try:
                    ...
                    await self._reset_http_bridge_session_after_local_terminal_error(
                        ...
                        probe_owner=recovery_request_state,
                        preserve_error=preserve_error,
                        proxy_continuity_loss_detail=(
                            "previous_response_not_found"
                            if recovery_request_state.proxy_injected_previous_response_id
                            else None
                        ),
                    )
                except BaseException:
            ...
            if should_attempt_context_overflow_fresh_turn_recovery:
                ...
                await reset_stale_anchor_session_for_replay(session, request_state, preserve_error=exc)
                switch_to_account_neutral_replay(
